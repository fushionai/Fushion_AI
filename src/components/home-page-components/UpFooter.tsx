...
const UpFooter = () => {
  return (
    <section className="relative py-[120px] px-[143px] max-md:py-[40px] max-md:px-[16px]">
      <Image
        src={heroBg}
      ...
      <main className="max-container">
        <h2 className="font-ubuntu font-bold text-[64px] max-md:text-[32px] leading-[73px] max-md:leading-[48px]  text-primaryWhite max-md:text-center md:pr-[460px]">
